...
public class PresidentsService {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(President.class);

    /**
     * Default constructor for the service. This service will lead the readonly data of the {@link President}s
     */
    ...
    public List<President> getPresidents() { return presidents; }
